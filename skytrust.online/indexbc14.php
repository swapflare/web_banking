...
<link rel="stylesheet" type="text/css" href="ui/css/style52e552e552e5.css?p=1587912412">
  ...
  <div class="container">
    <div class="row">
      <nav class="navbar navbar-default bootsnav">
        ...
        <div class="attr-nav">
            <a class="scrolling getquote btn-dark text-uppercase border_radius" href="register">Start Banking</a>
        </div>
         <div class="attr-nav">
        ...
        <div class="navbar-header">
          ...
          <i class="fa fa-bars"></i>
            ...
            <a class="navbar-brand" href="/">
                <br><span class="blue_t"><h3><strong><?php echo $bname;?> </strong> Bank</h3></span>
                </a>
        </div>
    ...
    <li class=" ">
            ...
            <li class=" ">
              <a href="register" class="border">REGISTER
              </a>
            </li>
          </ul>
  ...
  <div id="rev_slider" class="rev_slider top" data-version="5.0">
    <ul>
        ...
        data-responsive_offset="on" data-transform_idle="o:1;" data-transform_in="y:-50px;opacity:0;s:1500;e:Power3.easeOut;" data-transform_out="s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;" data-start="1600">
            <a href="about" class="btn-border text-uppercase border_radius">About us
          </a>
          <a href="login" class="text-uppercase border_radius btn-blue">Get started
          </a>
        </div>
      </li>
      <li data-transition="fade" data-slotamount="7" data-masterspeed="1500">
        ...
        <div class="tp-caption  tp-resizeme"  
         data-x="['left','left','left','center']" data-hoffset="['0','15','15','15']" 
          data-y="['410','310','290','180']" data-voffset="['0','0','0','0']"
        data-responsive_offset="on" data-transform_idle="o:1;" data-transform_in="y:-50px;opacity:0;s:1500;e:Power3.easeOut;" data-transform_out="s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;" data-start="1600">
            <a href="about" class="btn-border text-uppercase border_radius btn-blue_t">About us
          </a>
          <a href="login" class="text-uppercase border_radius btn-blue">Get started
          </a>
        </div>
      ...
      <li data-transition="fade">
        ...
        <div class="tp-caption  tp-resizeme"  
         ...
         data-y="['410','310','290','180']" data-voffset="['0','0','0','0']"
        data-responsive_offset="on" data-transform_idle="o:1;" data-transform_in="y:-50px;opacity:0;s:1500;e:Power3.easeOut;" data-transform_out="s:1000;e:Power3.easeInOut;s:1000;e:Power3.easeInOut;" data-start="1600">
            <a href="indexe47e-2.php?a=about" class="btn-border text-uppercase border_radius">About us
          </a>
          <a href="register"  class="text-uppercase border_radius btn-blue">Register
          </a>
        </div>
      </li>
    </ul>
...
<section id="info" class="padding">
  <div class="container">
    ...
    <div class="row">
      <div class="col-sm-4">
        <div class="text_box text-center top40 wow fadeIn" data-wow-delay="700ms"><a href="register"> 
      ...
      <div class="col-sm-4">
        <div class="text_box text-center top40 wow fadeIn" data-wow-delay="900ms"><a href="register"></a> 
      ...
      <div class="col-sm-4">
        <div class="text_box  text-center top40 wow fadeIn" data-wow-delay="1100ms"><a href="https://<?php echo $bname;?>/login>           <span><i class="icon-bargraph"></i></span></a>
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 content_right shadow  margin-bottom">
        <div id="plan_slider" class="owl-carousel">
          ...
          <div class="item">
            ...
            <a href="indexe47e-2.php?a=about" class="btn-border text-uppercase border_radius">Read More</a>
          </div>
          <div class="item">
      ...
      <div id="news_slider" class="owl-carousel">
        <div class="item">
          <div class="news">
            ...
            <div class="news_text">
              <h4 class="bottom10"><a href="news">Trading</a></h4>
        ...
        <div class="item">
          <div class="news">
            ...
            <div class="news_text">
              <h4 class="bottom10"><a href="news">Investment</a></h4>
        ...
        <div class="item">
          ...
          <div class="news">
            ...
            <div class="news_text">
              <h4 class="bottom10"><a href="news">Loan</a></h4>
  ...
  <div class="row ">
    <div class="col-sm-4">
      <div class="contact_inner">
        ...
        <h5><strong>Email us : <a href="href="mailto:<?php echo $email;?>"><span class="__cf_email__" data-cfemail="ccbfb9bcbca3beb88cbfa7b5b8beb9bfb8e2a3a2a0a5a2a9">[email&#160;protected]</span></a></strong></h5>
    ...
    <div class="row">
      ...
      <div class="col-sm-4 footer_panel heading_space">
        ...
        <ul class="links">
          ...
          <li><a href="login"><i class="icon-chevron-small-right"></i>Start Banking</a></li>
        </ul>
      </div>
      <div class="col-sm-4 footer_panel heading_space">
