...
<!-- Site Content Wrapper -->
            ...
            <div class="dt-content-wrapper">
                ...
                <div class="dt-content">
                    ...
                    <div class="dt-page__header">
                        ...
                        <h1 class="dt-page__title"><?php echo $_SESSION[staffid]; ?></h1>
  ...
  <!-- Grid Item -->
            <div class="col-xl-12 col-md-6 order-xl-4">
              ...
              <!-- Card -->
              <div class="dt-card bg-primy text-black">
...
{
    if (mysqli_real_escape_string($con,$_POST[newpass]) == $_POST[confpass])
    {
mysqli_query($con,"UPDATE staff SET password='$_POST[newpass]' where username='$_SESSION[staffid]'");
