...
{   mysqli_query($con,"INSERT INTO transactions (cashier,type,paymentdate,charged,amount,paymentstat) VALUES ('$_SESSION[staffid]','Debit','$dt','$_REQUEST[custid]','$_REQUEST[amount]','active')");
