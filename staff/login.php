...
$query="SELECT * FROM staff WHERE username='$logid' AND password='$password'";
$res=  mysqli_query($con,$query);
if(mysqli_num_rows($res) == 1)
	{
		
		$_SESSION["staffid"] =$_POST["login"];
		header("Location: dashboard.php");
	}
        ...
        <header class="headers text-center d-none">
            <div class="container">
                <div class="branding">
                    ...
                    <h1 class="logo">
                        <span class="text-highlight"><? echo $bname;?> Online Banking System</span>
                    </h1>
                </div><!--//branding-->
                <div class="tagline">
                    ...
                    <div class="dt-login__content-inner">
                        ...
                        <form action="login.php" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" class="form-control " name="password" id="password-1" placeholder="Enter Staff Password">
                                </div>
                            <!-- /form group -->
