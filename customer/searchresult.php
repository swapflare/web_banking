...
<?php
    ...
    if(strlen($query) >= $min_length){ // if query length is more or equal minimum length then
        ...
        $raw_results = mysqli_query($con,"SELECT * FROM transactions
            WHERE (`type` LIKE '%".$query."%') OR (`receiveid` LIKE '%".$query."%')  AND (payeeid='$_SESSION[customerid]') ") or die(mysqli_error());
