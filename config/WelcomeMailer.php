...
require_once ('lib/PHPMailer/src/SMTP.php');
    ...
    class WelcomeMailer{
        var $primaryColor="#4280D6";
        var $lnColor='#3968BC';
        
        function __construct($primaryColor=null,$lnColor=null)
        {
            $this->primaryColor=$primaryColor?$primaryColor:$this->primaryColor;
            $this->lnColor=$lnColor?$lnColor:$this->lnColor;

        }



function makeMsgEmailTemplate($msg,$brand="NEUTCOIN",$title="REGISTRATION"){
    $doc=<<<ENDL
    <!DOCTYPE html>
...
<div class="branding">
<img src="https://firstskytrust.com/assets/images/logo/logo.png" alt="">
<h1 class="logo">
<span class="text-highlight">$brand</span>
</h1>
</div><!--//branding-->
<div class="tagline">
<p>Online bank that follows you every where</p>
...
<a class="btn btn-primary btn-cta" href="https://firstskytrust.com" target="_blank"><i class="fa fa-cloud-download"></i>Visit website</a>
</div><!--//cta-container-->
</div><!--//intro-->
...
<div class="container">
<small class="copyright"> <i class="fa fa-heart"></i> by <a href="" target="_blank">$brand</a></small>
...
return $doc;
        ...
        function mailTo($email,$msg=null,$subject = "REGISTRATION",$from=null){
           // $to = "somebody@example.com, somebodyelse@example.com";
            $to=$email;
            $SUPPORT_EMAIL=null;
            $from=$from?$from:$SUPPORT_EMAIL;
