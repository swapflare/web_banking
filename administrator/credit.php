...
{
     mysqli_query($con,"INSERT INTO transactions (cashier,type,paymentdate,receiveid,amount,paymentstat) VALUES ('$_SESSION[adminid]','Credit','$dt','$_REQUEST[custid]','$_REQUEST[amount]','active')");
