...
$result = mysqli_query($con,"SELECT * FROM mail where senderid='$_SESSION[adminid]'");
?>
...
if(isset($_POST["sendmsg"]))
{
    ...
    if(isset($_SESSION['adminid']))
    {
        ...
        $profile_holder = mysqli_query($con,"select * from customers WHERE customerid='$_POST[sendto]'");
