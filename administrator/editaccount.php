...
$results = mysqli_query($con,"SELECT * FROM accounts where customerid='$_GET[custid]'");
$custid=$_GET['custid'];
...
{    
    $sql = "update customers set country ='$_POST[country]', accstatus ='$_POST[accstatus]', acctype ='$_POST[acctype]', accpassword ='$_POST[accountpass]', transpassword ='$_POST[transactionpass]', state ='$_POST[state]', city ='$_POST[city]',  phone ='$_POST[phone]',  firstname ='$_POST[fname]',  lastname ='$_POST[lname]', email ='$_POST[email]',accopendate='$_POST[accopendate]' WHERE customerid='$_GET[custid]'";
    $sql2 = "update accounts set accstatus ='$_POST[accstatus]', accounttype ='$_POST[acctype]' WHERE customerid='$_GET[custid]'";
...
<option value="Zimbabwe">Zimbabwe</option>
 ...
 <div class="col-sm-6">
                      ...
                      <input required type="text" value="<? echo $accopendate?>" name="accopendate" id="accopendate" class="form-control">
