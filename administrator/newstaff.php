            ...
            <div class="dt-content-wrapper">
                ...
                <div class="dt-content">
                    ...
                    <div class="dt-page__header">
                        ...
                        <h1 class="dt-page__title">New Staff Account</h1>
...
{
    $sql="SELECT * FROM staff WHERE loginid='".$_POST['loginid']."'";
    if(mysqli_num_rows(mysqli_query($con,$sql)) > 0)
    {
     echo"<script>swal('Error!', 'Staff Account Login Id Alredy Created!', 'error')</script>";
    }
    else
    {
    $sql="INSERT INTO staff (phone, email, firstname, lastname, username, password, country, state, bank_branch, createdat) VALUES ('$_POST[phone]','$_POST[email]','$_POST[firstname]','$_POST[lastname]','$_POST[loginid]','$_POST[accountpassword]','$_POST[country]','$_POST[state]','$_POST[brname]','$m')";
    mysqli_query($con,$sql);
    if (!mysqli_query($con,$sql))
    {
    die('Error: ' . mysqli_error($con));
    }
   echo"<script>swal('Success!', 'Staff Account Created Successfully!', 'success')</script>";
    }
}
                ...
                <div class="dt-card__header">
                  ...
                  <div class="dt-card__heading">
                    <div class="d-flex align-items-center">
                      ...
                      <h3 class="dt-card__title text-white"> Create New Staff Account</h3>
                    </div>
                  </div>
                  <!-- /card heading -->
...
function valid()
{
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>Select Staff Bank Branch</label>
    ...
    <!-- Grid Item -->
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>Select Staff Nationality</label>
...
<option value="Zimbabwe">Zimbabwe</option>
 ...
 <div class="col-sm-6">
                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          <label>Staff Account Activation</label>
                ...
                <div class="px-7 py-5 border-top border-width-2 border-black-transparent">
                 ...
                 <tr>
        	      <td colspan="2"><div align="right">
        	        <input  type="submit" name="button" id="button"  class="btn btn-danger" value="Open Account" />
        	      </div></td>
       	        </tr></div>
                <!-- /card footer -->
 </form>
